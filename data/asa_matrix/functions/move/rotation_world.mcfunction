...
# Set_Vector
execute store result score #asa_move_pos_x AsaMatrix run scoreboard players get #asa_matrix_x_x AsaMatrix
execute store result score #asa_move_pos_z AsaMatrix run scoreboard players get #asa_matrix_z_z AsaMatrix